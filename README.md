...
A simple authentication node for ForgeRock's [Identity Platform][forgerock_platform] 6.5.0. This node retrieves a single user profile attribute and compares to the submitted value.
